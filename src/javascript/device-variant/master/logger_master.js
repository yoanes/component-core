	...
	_cmd: function() {
		...
		cmdRun.value = "Run";
	 	...
	 	if(document.attachEvent)
     		cmdRun.attachEvent("onclick" , function() { _exec(document.getElementById('cmd').value);return false; });
    	else cmdRun.setAttribute("onclick", "_exec(document.getElementById('cmd').value);return false;");
